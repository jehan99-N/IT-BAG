  ...
  <div class="d-flex" id="wrapper" >
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="list-group list-group-flush">
        ...
        <a href="favourite.php" class="list-group-item list-group-item-action bg-light active"><i class="fas fa-heart" style="color: #cda45e;padding-right: 10px;"></i>Favourite</a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            <p>“Don’t worry if it doesn’t work right.<br>If everything did, you’d be out of a job.”</p>
          </div>
        </div>
      </div>
    </div>
