  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="list-group list-group-flush">
        ...
        <a href="note.php" class="list-group-item list-group-item-action bg-light active"><i class="fas fa-sticky-note" style="color: #cda45e;padding-right: 10px;"></i>Sticky Notes</a>
