<?php include 'contactpersonalback.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
      ...
      <h1 class="logo mr-auto"><a href="index.php"><img src="assets/img/124.png" alt="" style=" margin: -10px"></a></h1>
       <nav class="nav-menu d-none d-md-block">
          <ul>
            ...
            <li class="active"><a href="pcontact.php">Contact</a></li>
          </ul>
        </nav>
        <!-- .nav-menu -->
      </div>
    ...
    <div class="wrap-contact100">
        <form class="contact100-form" method="POST" action="#">
            ...
            <div class="wrap-input100">     
                <input id="name" class="input100" type="text" autocomplete="off" name="subjectp" placeholder="Enter your Subject...">
            </div>

            <div class="wrap-input100">
                <textarea id="message" class="input100" name="messagep" placeholder="Type your message here..."></textarea>
            </div>
   
            <div class="container-contact100-form-btn">
              <input type="submit" name="subpersonal" class="contact100-form-btn" value="Send">
            </div>
            <?php if(isset($result)) {
              ...
              echo '<div class="alert alert-danger text-center m-1" style="margin-top:-65px">'.$error.'</div>';
            } ?>
        </form>
