  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="list-group list-group-flush">
        <a href="profile.php" class="list-group-item list-group-item-action bg-light active"><i class="fas fa-user-alt" style="color: #cda45e;padding-right: 10px;"></i>Profile</a>
        ...
        <a href="calender.php" class="list-group-item list-group-item-action bg-light"><i class="fas fa-calendar-week" style="color: #cda45e;padding-right: 10px;"></i>Calender</a>
                    ...
                    <div class="row m-l-0 m-r-0"> 
                        ...
                        <div class="col-sm-8">
                            <div class="card-block" style="margin-top:20px">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p class="m-b-10 mt-3 f-w-600">Bio</p>
                                        <h5 class="text-muted f-w-400"><?php if($_SESSION['BIO'] == '') {echo "Age,City,Gender,...";}else{echo $_SESSION['BIO']; } ?></h5>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 mt-3 f-w-600">Interested in</p>
                                       
                                        <h5 class="text-muted f-w-400"><?php $arr= array(); array_push($arr,$_SESSION['intersted']); if($_SESSION['intersted'] == '') {echo "Applecation,Web, Frontend,...";}else{echo implode("D" , $arr) ; } ?></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
